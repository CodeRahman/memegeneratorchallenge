...
function clearAll() {
  ...
  function showMeme() {
    ...
    const memecontain = document.querySelector('.meme-content')
    const memesel =  (document.createElement('img'));
    memesel.setAttribute('src', randomMemeUrl);
    
    
    clearAll();
    
    memecontain.appendChild(memesel);
  }
  ...
  function showJoke() {
    ...
    const jokecontain = document.querySelector('.joke-content')
    const jokesel =  (document.createElement('p'));
    jokesel.textContent = randomJokeText;
    
    
    clearAll();
    
    jokecontain.appendChild(jokesel);
  }
  ...
  function showQuote() {
    ...
    const quotecontain = document.querySelector('.quote-content')
    const quotesel =  (document.createElement('p'));
    const quoteauthorsel =  (document.createElement('p'));
    quotesel.textContent = randomQuote.quote;
    quoteauthorsel.textContent = '-' + randomQuote.author;
    
    
    clearAll();
    
    quotecontain.appendChild(quotesel);
    quotecontain.appendChild(quoteauthorsel);
  }
